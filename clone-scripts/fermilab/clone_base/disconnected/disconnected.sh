...
#    1)   qsub -V -N decayf8l24t48b48m00889_500.sh decay.sh
...
short_runname=`echo $runname | sed -e s/disc//`

run=${PBS_JOBNAME}
fname=`echo $run | sed -e s/.sh// -e s/disc//`
