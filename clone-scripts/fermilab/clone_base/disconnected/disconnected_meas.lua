...
-- Stuff for dilution!
local num_src = 6 -- Use 6 sources.
local color_dil = qopqdp.defaultNc(); -- Set to 1 to not color dilute!
local source_type = "U1" -- other option is "Z2".

-- Must be set to not zero to use lowmemory dilution.
local time_dil = nt -- set to 1 to not time dilute. 
local space_dil = 2 -- set to 1 to not space even/odd dilute
