...
local cg_prec = 1e-12 -- Max residual of CG.
...
local dogaugefix = 0; -- if you want to fix to coulomb gauge, set to 1.
...
do
	...
	for srcnum=1,#time_sources do
		...
		for tt=1,nt do
			...
			C_i2[tt] = adg_sub(adg_sub(adg_add(Cdirect1324[tt],Cdirect1423[tt]),Ccrossed1324[tt]),Ccrossed1423[tt]);
